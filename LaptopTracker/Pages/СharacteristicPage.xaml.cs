...
namespace LaptopTracker.Pages
{
    public partial class СharacteristicPage : Page
    {
        ...
        string GenerateDescpriptionText()
        {
            ...
            sb.AppendLine($"Оценка производительности: {deviceCard.Device.Laptop.PerfomanceRate.Name}\n(балл производительности: {deviceCard.Device.Laptop.PerfomanceRateValue})");
